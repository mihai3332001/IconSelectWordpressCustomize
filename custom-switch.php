class eveline__select_icon_control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<input type="hidden" id="icon_select2" <?php $this->link(); ?> value="<?php
					echo $this->value(); ?>" />
			<select id="icons-custom" class="icons-custom">
			<option value="font-awesome">Font-awesome Icon</option>
    ...
    class eveline_icon_custom_select_control extends WP_Customize_Control {

        public $type = 'text';
        public function render_content() {
            $text =  '<strong style="color:#ff0000;">' . esc_html($this->label) . '</strong>';
            $text .= '<br />';
            $text .=  esc_html($this->description);
            echo $text;
            ?>

            <div class="custom_iconmoon">
            <input type="hidden" id="iconmoon_custom" <?php $this->link(); ?> value="<?php
                    echo $this->value(); ?>" />
            <select id="iconmoon" class="iconmoon">
    <option value="icon-alert-circle">&#xe90e; icon-alert-circle</option>
    <option value="icon-at-sign">&#xe912; icon-at-sign</option>
    <option value="icon-attachment">&#xe9cd; icon-attachment</option>
    <option value="icon-bubble2">&#xe96e; icon-bubble</option>
    <option value="icon-bubble4">&#xe970; icon-bubble2</option>
    <option value="icon-cart">&#xe93a; icon-cart</option>
    <option value="icon-check-circle">&#xe900; icon-check-circle</option>
    <option value="icon-check-square">&#xe901; icon-check-square</option>
    <option value="icon-clock">&#xe94e; icon-clock</option>
    <option value="icon-coin-dollar">&#xe93b; icon-coin-dollar</option>
    <option value="icon-credit-card">&#xe93f; icon-credit-card</option>
    <option value="icon-envelop">&#xe945; icon-envelop</option>
    <option value="icon-earth">&#xe9ca; icon-earth</option>
    <option value="icon-facebook">&#xe902; icon-facebook</option>
    <option value="icon-facebook1">&#xea90; icon-facebook1</option>
    <option value="icon-gift">&#xe913; icon-gift</option>
    <option value="icon-google-plus3">&#xea8d; icon-google-plus3</option>
    <option value="icon-heart">&#xe9da; icon-heart</option>
    <option value="icon-heart1">&#xe914; icon-heart1</option>
    <option value="icon-home3">&#xe90f; icon-home</option>
    <option value="icon-info">&#xe903; icon-info</option>
    <option value="icon-instagram">&#xea92; icon-instagram</option>
    <option value="icon-instagram1">&#xe904; icon-instagram1</option>
    ...
    <option value="icon-mail4">&#xea86; icon-mail2</option>
    <option value="icon-map-pin">&#xe906; icon-map-pin</option>
    <option value="icon-map2">&#xe94c; icon-map2</option>
    <option value="icon-message-circle">&#xe907; icon-message-circle</option>
    <option value="icon-message-square">&#xe908; icon-message-square</option>
    <option value="icon-mug">&#xe9a2; icon-mug</option>
    <option value="icon-notification">&#xea08; icon-notification</option>
    <option value="icon-paperclip">&#xe915; icon-paperclip</option>
    <option value="icon-phone">&#xe942; icon-phone</option>
    <option value="icon-phone1">&#xe916; icon-phone1</option>
    <option value="icon-printer">&#xe954; icon-printer</option>
    <option value="icon-search">&#xe909; icon-search</option>
    <option value="icon-share-2">&#xe90a; icon-share</option>
    <option value="icon-shopping-bag">&#xe90b; icon-shopping-bag</option>
    ...
    <option value="icon-twitter1">&#xe90d; icon-twitter1</option>
    <option value="icon-users">&#xe972; icon-users</option>
    <option value="icon-user-tie">&#xe976; icon-user-tie</option>
	...
	class eveline_icon_awesome_select_control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<div class="custom_icon_awesome">
			<input type="hidden" id="icon_select" <?php $this->link(); ?> value="<?php
					echo $this->value(); ?>" />
